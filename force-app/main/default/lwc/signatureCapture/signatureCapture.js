...
import saveSign from '@salesforce/apex/signatureCaptureController.saveSign';
...
export default class CapturequestedEventignature extends LightningElement {
    ...
    constructor() {
        ...
        this.template.addEventListener('touchmove', this.handleMouseMoveMobile.bind(this));
        this.template.addEventListener('touchstart', this.handleMouseDownMobile.bind(this));
        this.template.addEventListener('touchend', this.handleMouseUpMobile.bind(this));
    }
    ...
    handleMouseOut(event){
        ...
        //handler for mouse move operation
        handleMouseMoveMobile(event){
            this.searchCoordinatesForEvent('move', event, true);      
        }
        
        //handler for mouse down operation
        handleMouseDownMobile(event){
            this.searchCoordinatesForEvent('down', event, true);         
        }
        
        //handler for mouse up operation
        handleMouseUpMobile(event){
            this.searchCoordinatesForEvent('out', event, true);       
        }
    ...
    */
    handleSaveClick(){    
        ...
        const signatureEvent = new CustomEvent("signaturecapture", {
            detail: convertedDataURI
          });
      
          // Dispatches the event.
        this.dispatchEvent(signatureEvent);
        /*
    ...
    searchCoordinatesForEvent(requestedEvent, event, mobile){
        if(!mobile){
